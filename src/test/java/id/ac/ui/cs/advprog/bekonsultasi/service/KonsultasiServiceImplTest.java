...
class KonsultasiServiceImplTest {
    ...
    void cancelKonsultasi_shouldCancelKonsultasi() {
        ...
        KonsultasiResponseDto result = konsultasiService.cancelKonsultasi(konsultasiId, caregiverId, "CAREGIVER");
    ...
    void rescheduleKonsultasi_shouldRescheduleKonsultasi() {
        ...
        KonsultasiResponseDto result = konsultasiService.rescheduleKonsultasi(konsultasiId, dto, caregiverId, "CAREGIVER");
